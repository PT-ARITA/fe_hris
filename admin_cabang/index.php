                ...
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        <div class="block-header bg-primary-dark">
                            <h3 class="block-title">Tambah Data Cabang</h3>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <select class="form-control" name="">
                                        ...
                                        <option value="">API / JAKARTA</option>
                                        <option value="">API / JATENG</option>
                                        <option value="">API / SUMATRA</option>
                                        <option value="">AIRA / JAKARTA</option>
                                        <option value="">ANS / KALIMANTAN</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-12">Kode Cabang</label>
                                <div class="col-md-12">
                                    <input type="text" class="form-control" name="" placeholder="Kode Cabang" value="JATENG-001" disabled>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-12">Nama Cabang</label>
                                <div class="col-md-12">
                                    <input type="text" class="form-control" name="" placeholder="Nama Cabang">
                                </div>
                            </div>
                            <div class="form-group row">
        ...
        <div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-labelledby="modal-popin" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-popin" role="document">
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        <div class="block-header bg-primary-dark">
                            <h3 class="block-title">Edit Data Cabang</h3>
                            <div class="block-options">
                                <button type="button" class="btn-block-option" data-dismiss="modal" aria-label="Close">
                                    <i class="si si-close"></i>
                                </button>
                        ...
                        <div class="block-content">
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <select class="form-control" name="">
                                        <!-- <option value="">Please select</option> -->
                                        <option value="" disabled>API / JAKARTA</option>
                                        <option value="">API / JATENG</option>
                                        <option value="">API / SUMATRA</option>
                                        <option value="">AIRA / JAKARTA</option>
                                        <option value="">ANS / KALIMANTAN</option>
                            ...
                            <div class="form-group row">
                                <label class="col-12">Kode Cabang</label>
                                <div class="col-md-12">
                                    <input type="text" class="form-control" name="" value="JAKARTA-001" disabled>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-12">Nama Cabang</label>
        ...
        <div class="modal fade" id="modal-delete" tabindex="-1" role="dialog" aria-labelledby="modal-popin" aria-hidden="true">
            <div class="modal-dialog modal-dialog-popin" role="document">
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        <div class="block-header bg-primary-dark">
                            <h3 class="block-title">Delete Data Cabang</h3>
                            <div class="block-options">
                                <button type="button" class="btn-block-option" data-dismiss="modal" aria-label="Close">
                                    <i class="si si-close"></i>
                                </button>
                ...
                <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center"><b>Kode / Nama Cabang</b></th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center">JATENG-001 / Semarang</td>
                            <td class="">Simpang Lima</td>
